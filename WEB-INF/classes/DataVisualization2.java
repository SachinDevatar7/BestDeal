...
@WebServlet("/DataVisualization2")
public class DataVisualization2 extends HttpServlet {
    ...
    protected void displayPage(HttpServletRequest request, HttpServletResponse response, PrintWriter pw)
        ...
        pw.print("<h2 class='title meta'><a style='font-size: 24px;'>Bar Chart with product names and total number of items available:</a></h2>"
                + "<div class='entry'>");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            try{
                ...
                String query = "Select * from productDetails order by AvailableCount";
                ...
                while(rs.next()){
                    ...
                    System.out.print(rs.getString("AvailableCount"));                    
                    JSONObject obj = new JSONObject();
                    obj.put("product_name",rs.getString("productName"));
                    obj.put("product_quantity",rs.getString("AvailableCount"));
                    json.put(obj);
                }       
