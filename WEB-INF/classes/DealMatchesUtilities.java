...
public class DealMatchesUtilities extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("<img src='images/site/Iphone.png'style='width: 600px; display: block; margin-left: auto; margin-right: auto' />");
		pw.print("<br> <br>");
		pw.print("<h2>The world's fastest delivery!!!</h2>");
		pw.print("<br> <br>");
		pw.print("<h1>We beat our competitors in all aspects. Price-Match Guaranteed</h1>");
			...
			BufferedReader reader = new BufferedReader(new FileReader (new File(TOMCAT_HOME+"\\webapps\\SachinDevatarBestDeal\\DealMatches.txt")));
