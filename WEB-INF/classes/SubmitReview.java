	...
	protected void storeReview(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!utility.isLoggedin()){
			...
			return;
                ...
                String productionsale=request.getParameter("productionsale");
		...
		String message=utility.storeReview(productname,producttype,productmaker,reviewrating,reviewdate,reviewtext,userage,userid,usergender,useroccupation,
			retailerstate,productionsale,manufacturername,manufacturerrebate,retailerpin,productprice,retailercity);				     
