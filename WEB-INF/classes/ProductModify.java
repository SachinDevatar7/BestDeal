	...
	protected void doGet(HttpServletRequest request,
		...
		if(action.equals("Addproduct"))
		{
			...
			pw.print("<form method='get' action='ProductCrud'>"
					...
					+ "<h3>Product Type</h3></td><td><select name='producttype' class='input'><option value='tvs' selected>Tv</option><option value='games'>Sound Systems</option><option value='tablets'>Cell Phones</option><option value='accessories'>Laptops</option><option value='tablets'>Voice Assitant</option><option value='tablets'>Smart Watch</option><option value='tablets'>Headphones</option><option value='tablets'>Fitness Watch</option><option value='tablets'>WirelessPlan</option></select>"
					+ "</td></tr><tr><td>"
