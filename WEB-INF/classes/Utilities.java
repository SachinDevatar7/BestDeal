...
public class Utilities extends HttpServlet{
			...
			if (session.getAttribute("username")!=null){
				...
				if(session.getAttribute("usertype").equals("manager"))
				{
					result = result + "<li><a href='ProductModify?button=Addproduct'><span class='glyphicon'>Addproduct</span></a></li>"
						...
						+"<li><a href='InventoryLink'><span class='glyphicon'>InventoryLink</span></a></li>"
	...
	public void storePayment(int orderId,
     ...
     public String storeReview(String productname,String producttype,String productmaker,String reviewrating,String reviewdate,String  reviewtext,String userage, String userid, String usergender,String useroccupation,
     	String retailerstate,String productionsale,String manufacturername,String manufacturerrebate,String reatilerpin,String price,String city){
	String message=MongoDBDataStoreUtilities.insertReview(productname,username(),producttype,productmaker,reviewrating,reviewdate,reviewtext,userage,userid, usergender,useroccupation,
		retailerstate,productionsale,manufacturername,manufacturerrebate,reatilerpin,price,city);
		...
		Review review = new Review(productname,username(),producttype,productmaker,reviewrating,reviewdate,reviewtext,userage,userid,usergender,useroccupation,retailerstate,productionsale,manufacturername,manufacturerrebate,reatilerpin,price,city);
