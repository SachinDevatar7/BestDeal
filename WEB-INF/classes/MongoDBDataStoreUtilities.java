...
public static String insertReview(String productname,String username,String producttype,
	...
	String userage,String userid, String usergender,String useroccupation,
...
append("productionSale", productionsale).
	...
	while (cursor.hasNext())
	{
		   ...
		   if(!reviews.containsKey(obj.getString("productName")))
			...
			Review review =new Review(obj.getString("productName"),obj.getString("userName"),obj.getString("productType"),obj.getString("productMaker"),
				obj.getString("reviewRating"),obj.getString("reviewDate"),obj.getString("reviewText"),obj.getString("userAge"),obj.getString("userId"),
				obj.getString("userGender"),obj.getString("userOccupation"),obj.getString("retailerState"),
				obj.getString("productionSale"),obj.getString("manufacturerName"),obj.getString("anufacturerRebate"),obj.getString("retailerpin"),obj.getString("price"),obj.getString("retailercity"));
